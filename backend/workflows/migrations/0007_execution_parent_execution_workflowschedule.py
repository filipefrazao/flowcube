# Generated migration for FlowCube Ultimate - Execution Engine
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Add parent_execution FK to Execution (for sub-workflows)
        migrations.AddField(
        ...
        # Create WorkflowSchedule model (Make-style 9 types)
