              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left px-4 py-3 text-xs font-medium text-text-muted uppercase">Descricao</th>
                    <th className="text-left px-4 py-3 text-xs font-medium text-text-muted uppercase">Participantes</th>
                    <th className="text-left px-4 py-3 text-xs font-medium text-text-muted uppercase">Admin</th>
                  </tr>
                </thead>
                <tbody>
                  {groups.map((g, i) => (
                    <tr key={i} className="border-b border-border/50 hover:bg-surface-hover/30">
                      ...
                      <td className="px-4 py-3 text-sm text-text-secondary">{g.description || "-"}</td>
                      <td className="px-4 py-3 text-sm text-text-secondary">{g.participants_count || 0}</td>
                      <td className="px-4 py-3">
                        {g.is_admin && <span className="px-2 py-1 bg-primary/20 text-primary rounded-full text-xs">Admin</span>}
                      </td>
                    </tr>
                  ))}
                </tbody>
