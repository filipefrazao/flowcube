      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 border-b border-gray-700 bg-gray-900 flex items-center justify-between px-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold text-gray-100">Squads</h1>
          </div>
        ...
        <div className="p-6 flex-1 overflow-auto">
          {loading ? (
            ...
            <div className="text-center py-20 text-gray-400"><Shield className="w-12 h-12 mx-auto mb-3 opacity-50" /><p>Nenhum squad encontrado</p></div>
          ) : (
            <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
              <table className="w-full">
                <thead><tr className="border-b border-gray-700">
                  <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase">Nome</th>
                  <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase">Unidade</th>
                  <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase">Lider</th>
                ...
                <tbody>
                  {squads.map((s) => (
                    <tr key={s.id} className="border-b border-gray-700/50 hover:bg-gray-700/30">
                      ...
                      <td className="px-4 py-3 text-sm text-gray-300">{s.unit_name || "-"}</td>
                      <td className="px-4 py-3 text-sm text-gray-300">{s.leader}</td>
                      <td className="px-4 py-3 text-sm text-gray-300">{s.members_count || 0}</td>
          ...
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 w-full max-w-md">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-100">Novo Squad</h2>
              ...
              <div className="space-y-4">
                ...
                <div><label className="block text-sm text-gray-300 mb-1">Lider</label>
