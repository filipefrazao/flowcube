      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            disabled={loading}
            className="flex-1 px-4 py-2 bg-surface/50 border border-border rounded-lg text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-purple-500 resize-none disabled:opacity-50"
          />
          <button
            onClick={handleSend}
            disabled={!input.trim() || loading}
            className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-text-primary rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
